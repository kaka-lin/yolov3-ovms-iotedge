...
class ArgumentParser:
    ...
    def GetGrpcServerPort(self):
        if (self._arguments.p is not None):
            if isinstance(self._arguments.p, list):
                return self._arguments.p[0]
            else:
                return self._arguments.p
        else:
            raise Exception(
                'Command line parameter for gRPC server port is missing.')
    ...
    def GetGrpcServerAddress(self):
        if (self._arguments.s is not None):
            ...
            raise Exception(
                'Command line parameter for gRPC server address is missing.')
    ...
    def GetSampleMediaAddress(self):
        if (self._arguments.f is not None):
            ...
            raise Exception(
                'Command line parameter for media file name is missing.')
    ...
    def GetLoopCount(self):
        if (self._arguments.f is not None):
            ...
            raise Exception(
                'Command line parameter for loop count is missing.')
